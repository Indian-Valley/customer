        ...
        <SafeAreaView className='w-full h-screen'>
            ...
            <View className='h-2/5 flex-col justify-between mt-auto'>
                <View className='my-auto'>
                    <Text style={{color: colors.text}} className='text-center mt-3 font-extrabold text-3xl'>Indian Valley</Text>
                    <Text style={{color: colors.text}} className='text-center w-3/4 mt-3 mx-auto '>Indian Cuisine in the heart of Orpington,
